...
const DOMAIN_KEYWORDS = {
  ...
  seo: { keywords: ['seo', 'meta tag', 'sitemap', 'robots', 'schema markup', 'posicionamiento', 'ranking', 'search engine', 'crawl', 'indexacion', 'serp'], agents: [], skills: [], commands: ['/seo'], skillMap: { seo: '/seo', 'meta tag': '/seo-meta', sitemap: '/seo-crawl', robots: '/seo-crawl', 'schema markup': '/seo-schema', posicionamiento: '/seo-audit', ranking: '/seo-audit', 'search engine': '/seo-audit', crawl: '/seo-crawl', indexacion: '/seo-crawl', serp: '/seo-keywords' } },
  ai_seo: { keywords: ['ai seo', 'ai search', 'llm search', 'chatgpt search', 'perplexity', 'ai optimization'], agents: [], skills: ['ai-seo'] },
  marketing: { keywords: ['marketing', 'mercadeo', 'campaña', 'campaign', 'audiencia', 'audience', 'brand', 'marca', 'growth', 'crecimiento', 'psicologia', 'psychology', 'estrategia marketing'], agents: [], skills: [], skillMap: { marketing: 'marketing-ideas', mercadeo: 'marketing-ideas', 'campaña': 'marketing-ideas', campaign: 'marketing-ideas', audiencia: 'marketing-psychology', audience: 'marketing-psychology', brand: 'product-marketing-context', marca: 'product-marketing-context', growth: 'launch-strategy', crecimiento: 'launch-strategy', psicologia: 'marketing-psychology', psychology: 'marketing-psychology', 'estrategia marketing': 'content-strategy' } },
  content: { keywords: ['articulo', 'article', 'blog post', 'newsletter', 'contenido', 'content creation', 'copywriting', 'redaccion', 'escribir articulo', 'write article'], agents: [], skills: [], skillMap: { articulo: 'article-writing', article: 'article-writing', 'blog post': 'article-writing', newsletter: 'article-writing', contenido: 'content-engine', 'content creation': 'content-engine', copywriting: 'copywriting', redaccion: 'copywriting', 'escribir articulo': 'article-writing', 'write article': 'article-writing' } },
  email_outreach: { keywords: ['cold email', 'email sequence', 'email marketing', 'outreach', 'follow up', 'seguimiento', 'drip', 'secuencia email'], agents: [], skills: [], skillMap: { 'cold email': 'cold-email', 'email sequence': 'email-sequence', 'email marketing': 'email-sequence', outreach: 'cold-email', 'follow up': 'email-sequence', seguimiento: 'email-sequence', drip: 'email-sequence', 'secuencia email': 'email-sequence' } },
  social: { keywords: ['social media', 'redes sociales', 'instagram', 'linkedin', 'twitter', 'tiktok', 'post social', 'social content'], agents: [], skills: ['social-content'] },
  cro: { keywords: ['conversion', 'conversión', 'cro', 'optimize page', 'optimizar pagina', 'landing page', 'signup flow', 'onboarding flow', 'paywall', 'churn', 'popup', 'modal', 'a/b test', 'ab test'], agents: [], skills: [], skillMap: { conversion: 'page-cro', 'conversión': 'page-cro', cro: 'page-cro', 'optimize page': 'page-cro', 'optimizar pagina': 'page-cro', 'landing page': 'page-cro', 'signup flow': 'signup-flow-cro', 'onboarding flow': 'onboarding-cro', paywall: 'paywall-upgrade-cro', churn: 'churn-prevention', popup: 'popup-cro', modal: 'popup-cro', 'a/b test': 'ab-test-setup', 'ab test': 'ab-test-setup' } },
  sales: { keywords: ['sales', 'ventas', 'pitch', 'propuesta', 'proposal', 'lead magnet', 'referral', 'revenue', 'pricing', 'precios'], agents: [], skills: [], skillMap: { sales: 'sales-enablement', ventas: 'sales-enablement', pitch: 'sales-enablement', propuesta: 'sales-enablement', proposal: 'sales-enablement', 'lead magnet': 'lead-magnets', referral: 'referral-program', revenue: 'revops', pricing: 'pricing-strategy', precios: 'pricing-strategy' } },
  debugging: { keywords: ['debug', 'debugging', 'depurar', 'bug', 'error', 'fallo', 'crash', 'traceback', 'stack trace', 'root cause', 'causa raiz', 'investigar error'], agents: [], skills: ['investigate'], gstack: '/investigate' },
  research: { keywords: ['investigar', 'research', 'buscar informacion', 'analizar mercado', 'competitor', 'competencia', 'due diligence'], agents: [], skills: [], skillMap: { investigar: 'deep-research', research: 'deep-research', 'buscar informacion': 'deep-research', 'analizar mercado': 'market-research', competitor: 'competitor-alternatives', competencia: 'competitor-alternatives', 'due diligence': 'market-research' } },
  video: { keywords: ['video', 'editar video', 'edit video', 'ffmpeg', 'render', 'animacion', 'animation', 'motion', 'remotion', 'explainer'], agents: [], skills: [], skillMap: { video: 'video-editing', 'editar video': 'video-editing', 'edit video': 'video-editing', ffmpeg: 'ffmpeg', render: 'remotion-render', animacion: 'motion-designer', animation: 'motion-designer', motion: 'motion-designer', remotion: 'remotion-best-practices', explainer: 'explainer-video-guide' } },
  design_advanced: { keywords: ['design system', 'sistema de diseno', 'design consultation', 'consulta diseno', 'design variants', 'variantes diseno', 'awwwards', 'animation css', 'micro interaction'], agents: [], skills: [], skillMap: { 'design system': 'design-system', 'sistema de diseno': 'design-system', 'design consultation': 'design-consultation', 'consulta diseno': 'design-consultation', 'design variants': 'design-shotgun', 'variantes diseno': 'design-shotgun', awwwards: 'awwwards-animations', 'animation css': 'awwwards-animations', 'micro interaction': 'emil-design-eng' } },
  performance: { keywords: ['performance', 'benchmark', 'optimize', 'slow', 'lento', 'cache', 'bundle', 'rendimiento', 'bottleneck', 'cuello de botella'], agents: ['performance-optimizer'], skills: ['performance-analysis'] },
  documentation: { keywords: ['readme', 'documentation', 'documentacion', 'api doc', 'swagger', 'openapi'], agents: ['docs-lookup'], skills: ['documentation-lookup', 'api-design'] },
  design: { keywords: ['canvas', 'theme', 'typography', 'color palette', 'visual design', 'logo', 'palette'], agents: [], skills: ['canvas-design', 'theme-factory', 'algorithmic-art', 'ui-ux-pro-max'] },
